...
def main():
    ...
    try:
        ...
        # Generate patterns using the high-fidelity vertex list
        ...
        print(f"Total holes: {len(all_holes)} (Cut: {len(cut_holes)}, Stoping: {len(stoping_holes)}, Contour: {len(contour_holes)})")
